...
grep -v -e '/bin/false' -e '/bin/nologin' dodatkowe/etc-passwd | cut -d ":" -f1

#teorytycznie uzytkownik moze daac bin/nologin w opisie ( wiec sprawdzac to w ramach kolumny)
