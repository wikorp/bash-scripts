...
grep -v 'USER' dodatkowe/ps-aux | cut -d " " -f1 | sort | uniq

#tez sprawdzac w ramach kolumny bo w innych kolumnach moze byc USER Np Tail zeby pominac pierwsza linijke
