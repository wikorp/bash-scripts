...
for FILE in dane/icao/*; do
	if test -ef dane/icao/alfa; then
		echo "assda"
	fi
done

#Program test ma odpowiednią opcję (-ef) do sprawdzenia tego. a mi tu blad wyskakuje

#dwa arhumenty, man test przyklad uzycia ef
