...
#
grep -E -o 'def[[:space:]]*([a-z]|_)*[[:space:]]*\(' dodatkowe/service.py | sort | uniq | awk '{print $2}' | grep -E -o '([a-z]|_)*'


#jak w grepie sie dostac do wybranej kolumny zeby nie trzeba bylo korzystac za awk
#to jest ok takie korzystanie z obu
