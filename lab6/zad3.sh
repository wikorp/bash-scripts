...
#
cat dodatkowe/cpplint.txt | sed 's/<[^>]*>//g' | sed '/^[[:space:]]*$/d'

#konczy sie dowolna iloscia bialych znakow 
#zaczyna sie od bialego znaku czy dowolnej ilosi balych znakow
#jak zaczyna sie od bialego znaku to samo przejscie do nowej lini powinno zostac a jedak jest usuniete
